...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contractor.user'
        db.add_column('minuteman_contractor', 'user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contractor.user'
        db.delete_column('minuteman_contractor', 'user_id')
