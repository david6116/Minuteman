...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Log.comments'
        db.add_column('minuteman_log', 'comments', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Log.comments'
        db.delete_column('minuteman_log', 'comments')
    ...
    models = {
        ...
        'minuteman.log': {
            'Meta': {'ordering': "('start',)", 'object_name': 'Log'},
